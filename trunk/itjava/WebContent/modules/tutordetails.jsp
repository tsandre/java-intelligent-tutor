        	...
        	<table width="600" border="0" cellspacing="0" cellpadding="0">
            	...
            	<tr>
					...
					//else if (deliverableName.contains("Quiz")) {
						messageToUser = "<b>Quiz Instruction</b><br/><i>Blanks appear in between the code. Fill in the blanks with appropriate code and click Done.</i><br/><i>If the answer you entered in the blank is correct, text box turns green in color.</i><br/><i>If the answer is wrong, the blank turns red in color. In this case, you can use hints and try re-typing the answer. (Info reg. using hints is given below).</i><br/><i>Fill in all the blanks in the Quiz. Click DONE to advance to the next step in the jTutor.<br/><i>The final hint is always answer to be filled in the blank. You will not recieve any points for a question that is answered using the final hint.</i><br/><br/><b>Example Instructions</b><br/><i>Read through the example code snippet and click DONE when you feel you have understood the snippet. The Quiz that follows the example should be related to the example snippet, so read carefully!</i><br/><br/>";
					//}
					%>
					</td></tr></table>

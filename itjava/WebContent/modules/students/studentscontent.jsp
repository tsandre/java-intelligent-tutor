    	...
    	<td align="center">
			<form action="CreateStudentServlet" method="post" name="form1" id="form1">
				<table width="450" border="0" cellspacing="0" cellpadding="0">
                	...
                	<tr>
                  		<td width="120" class="basic" style="text-align:right">First Name:</td>
                  		<td width="5">&nbsp;</td>
                	...
                	<tr>
                  		<td class="basic" style="text-align:right">Last Name:</td>
                  		<td>&nbsp;</td>
                	...
                	<tr>
                  		<td class="basic" style="text-align:right">Your School:</td>
                  		<td>&nbsp;</td>
                	...
                	<tr>
                  		<td class="basic" style="text-align:right">Email Address:</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td class="basic" style="text-align:right">Username:</td>
                  <td>&nbsp;</td>
                ...
                <tr>
                  <td class="basic" style="text-align:right">Confirm Password:</td>
                  <td>&nbsp;</td>

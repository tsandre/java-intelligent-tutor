...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
    	<td class="basic">
	        ...
	        String getcommonterms = "SELECT ClassInstanceTerms.* FROM ClassInstanceTerms ORDER BY numOccurrences DESC LIMIT 20";
	        ctucpst = ctconn.prepareStatement(getcommonterms);
	        ctrs = ctucpst.executeQuery();
		  	while(ctrs.next()){
		  		out.println("<tr>");
	            out.println("<td width=\"1\" bgcolor=\"#122222\"></td>");
	            out.println("<td bgcolor=\"#FFFFFF\" style=\"padding-left:10px; height:24px\"><a href=\"CodeSearchServlet?query=" + ctrs.getString("term") + "&btnSearch=Generate+Tutor\" class=\"mostpopular\" onclick=\"showProgress()\">" + ctrs.getString("term") + "</a></td>");
	            out.println("<td width=\"1\" bgcolor=\"#122222\"></td>");

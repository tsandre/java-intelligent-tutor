...
<table align="center" style="padding-top: 10px; margin: 0px;" cellspacing="0" cellpadding="0">
	<tr style="color:#fff;">
            <td colspan="3" bgcolor="#122222" align="center" style="padding: 0px; margin: 0px; color:#FFF; font-weight:bold; font-family:Arial, Helvetica, sans-serif; font-size:12px;">Find a Tutor</td>
        </tr>
        <tr>
            ...
            <td style="width:510px" align="center">
                <table cellspacing="0" cellpadding="0" >
                    <tr>
                        <td colspan="3" align="center">Enter a search term to find a tutor.</td>
                    </tr>
                    <tr>
                        <td>
